...
/**
 * Servlet implementation class SortByAutorServlet
 */
@WebServlet("/sortbyautor")
public class SortByAutorServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for(int i = 0; i < studentPlany.size(); i++) {
			studentPlany.get(i).setSortFactor(4);
		}
		...
		for(int i = 0; i < firmaPlany.size(); i++) {
			firmaPlany.get(i).setSortFactor(4);
		}
